        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20 bg-bl'>
          <form >
            <div className='realative mb-6'>
              <input type="name"
                className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none'
                id='name'
                value={name}
                onChange={onChange}
              ...
              />
              <input type="email"
                className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none md:mt-5 lg:mt-10'
                id='email'
                value={email}
                onChange={onChange}
              ...
              {showPassword
                ? <AiFillEye
                  ...
                  className='relative cursor-pointer text-xl top-[-30px] right-[-95%]'
                />
                : <AiFillEyeInvisible
                  onClick={() => setShowPassword(!showPassword)}
                  className='relative cursor-pointer text-xl top-[-30px] right-[-95%]'
              ...
              <div className='flex justify-between whitespace-nowrap text-sm sm:tex-lg'>
                ...
                <p>
                  ...
                  trasition duration-200 ease-in-out m-1'>Forgot Passowrd?</Link>
                </p>
              </div>
            </div>
